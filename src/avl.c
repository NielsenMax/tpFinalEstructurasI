 ...
 *  un numero negativo si el primero es menor y uno positivo si lo es el segundo
 ...
 *sin aumentar su altura. La formula para esto es, si la altura es h
 *2^(h+1) - 1.
*/
 ...
 *la diferencia de altura de sus dos arboles hijos es de menor o igual a 1.
*/
...
/**
 *avl_nodo_eliminar :: AVL_Nodo* -> void* -> FuncionComparadora -> FucionCopiadora -> FuncionDestructora -> AVL_Nodo*
 ...
 *Funcion estatica que toma un puntero a un nodo AVL y comprueba que se altura
